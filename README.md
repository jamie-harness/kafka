...
Kafka 4.0 (see [KIP-750](https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=181308223) for more details - Test).
...
Streams has multiple sub-projects, but you can run all the tests (Test):
